...
$body = $body . "Participa Moto Clube? " . $clube . "\n";
$body = $body . "Frequência de Uso da Moto? " . $frequencia . "\n";
$body = $body . "Seguro Novo ou Uma Renovação? " . $renovacao . "\n";
